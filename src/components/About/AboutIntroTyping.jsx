...
const AboutIntroTyping = () => {
  return (
    ...
    >
      ...
      <motion.p variants={lineVariants} className="font-medium text-slate-200">
        I specialize in the{" "}
        <span className="cursor-default font-semibold text-cyan-400 transition-colors hover:text-cyan-300">
          MERN stack
        </span>{" "}
        and enjoy designing{" "}
        <span className="cursor-default font-semibold text-sky-400 transition-colors hover:text-sky-300">
        ...
        , and{" "}
        <span className="cursor-default font-semibold text-indigo-400 transition-colors hover:text-indigo-300">
      ...
      <motion.p variants={lineVariants} className="font-medium text-slate-200">
        ...
        <span className="cursor-default font-semibold text-cyan-400 drop-shadow-sm transition-colors hover:text-cyan-300">
          React.js
        </span>
        ,{" "}
        <span className="cursor-default font-semibold text-cyan-400 drop-shadow-sm transition-colors hover:text-cyan-300">
        ...
        and lean on{" "}
        <span className="font-semibold text-cyan-400 transition-colors hover:text-cyan-300">
          Docker
        </span>
        ,{" "}
        <span className="font-semibold text-cyan-400 transition-colors hover:text-cyan-300">
      ...
      >
        ...
        <span className="font-semibold not-italic text-indigo-400">scalable system design</span>,{" "}
        <span className="font-semibold not-italic text-cyan-400 transition-colors hover:text-cyan-300">
