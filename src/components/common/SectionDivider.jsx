...
const SectionDivider = () => {
  return (
    <motion.div 
      ...
      className="relative w-full max-w-4xl mx-auto py-6 flex items-center justify-center opacity-80"
    >
      ...
      <div className="w-1.5 h-1.5 rounded-full bg-primary shadow-[0_0_10px_#22D3EE]" />
    </motion.div>
  );
};
