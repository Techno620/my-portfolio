  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6">
        <nav className="relative mx-auto max-w-7xl flex items-center justify-between gap-4 xl:gap-6 transition-all duration-500">
        ...
        <div className="hidden xl:block z-50 pl-3 xl:pl-5">
        ...
        {isMenuOpen && (
          <>
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 bg-[radial-gradient(circle_at_top,rgba(34,211,238,0.12),rgba(2,6,23,0.94)_45%)] backdrop-blur-lg z-[90] xl:hidden"
            ...
            <motion.div
              ...
              className="fixed inset-x-5 top-24 overflow-hidden rounded-[1.8rem] border border-cyan-300/18 bg-[linear-gradient(180deg,rgba(9,16,34,0.96),rgba(7,12,27,0.98))] p-5 z-[100] xl:hidden shadow-[0_24px_80px_-32px_rgba(0,0,0,0.9)]"
              role="dialog"
              aria-modal="true"
              ...
              <div className="relative flex flex-col gap-3">
                {navItems.map((item) => (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className={`group flex items-center justify-between gap-4 px-5 py-4 rounded-2xl text-[15px] font-mono font-bold uppercase tracking-[0.2em] transition-all outline-none focus-visible:ring-2 focus-visible:ring-secondary/60 ${activeSection === item.id
